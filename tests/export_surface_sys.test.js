// Export-surface parity: src/sys.js  <->  node:sys
// captured from real Node v24.20.0 (node:sys)
// Regenerate: node ~/workspace/bvm-export-helpers/gen_export_surface_tests.mjs
import * as shim from '../src/sys.js';
...
test('node:sys export surface matches the defined contract', () => {
